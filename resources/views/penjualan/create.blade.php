...
<div class="container">
  ...
  <div class="form-row">
    <div class="col">
    <label for="first_name"><font size="5">Full Name</font></label>
  ...
  <div clas="invalid-feedback"><font color="red" size="2">{{ $message }}</font></div>
    ...
    <div class="col">
    <label for="last_name"><font size="5">.</font></label>
  ...
  <div class="form-group">
    <label for="phone"><font size="5">Phone</font></label>
  ...
  <div class="form-group">
    ...
    id="email" placeholder="email@example.com" name="email" required>
    @error('email')
  <div clas="invalid-feedback"><font color="red" size="2">{{ $message }}</font></div>
      @enderror
  </div>
  ...
  <div class="form-group">
    <label for="street"><font size="5">Street</font></label>
    <input type="text" class="form-control @error('street') is-invalid @enderror" 
    id="street" placeholder="Masukkan Jalan " name="street" required>
    @error('street')
  <div clas="invalid-feedback"><font color="red" size="2">{{ $message }}</font></div>
      @enderror
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-4">
      <label for="city"><font size="5">City</font></label>
      <input type="text" class="form-control @error('city') is-invalid @enderror" 
      id="city" name="city" placeholder="Kota" required>
      @error('city')
  <div clas="invalid-feedback"><font color="red" size="2">{{ $message }}</font></div>
      @enderror
    </div>
    <div class="form-group col-md-4">
      <label for="state"><font size="5">State</font></label>
  ...
  <div clas="invalid-feedback"><font color="red" size="2">{{ $message }}</font></div>
    ...
    <div class="form-group col-md-4">
      <label for="zip_code"><font size="5">Zip_Code</font></label>
