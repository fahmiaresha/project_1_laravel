    ...
    <tr>
      ...
      <td>
        <a href="/customer/edit/{{ $cus->customer_Id }}" 
           class="badge badge-success"><svg class="bi bi-check-box" width="20px" height="20px" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
data-target="#exampleModal"><svg class="bi bi-trash-fill" width="15px" height="15px" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
