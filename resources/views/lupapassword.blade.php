...
@if(session('user_tdk_ada'))
     ...
     Swal.fire({
          ...
          icon: 'error',
          title: 'Oops',
          text: 'Job Status Tidak Terdaftar !',
        })
    </script>
    </font>
@endif
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-6 input-group" >
                            ...
                            <div class="form-group row">
                                <label for="job_status" class="col-md-4 col-form-label text-md-left"><font size="4" style="font-family: Arial, Helvetica, sans-serif;">Job Status</font></label>
                                <div class="col-md-6 input-group" >
                                <input id="job_status" type="text" placeholder="Job Status" class="form-control @error('job_status') is-invalid @enderror" name="job_status" >
                                    @error('job_status')
                                        <span class="invalid-feedback" role="alert">
                                            <strong><font size="2">{{ $message }} </font></strong>
                                        </span>
