...
function pilihBarang(id)
{
  ...
  cel_2.innerHTML = '<input type="text" name="harga[]" value="'+arrBarang[i][2]+'">';
  cel_3.innerHTML = '<input type="text" name="qty[]" value="1">';
  cel_4.innerHTML = '<input type="text" name="subtotal[]" value="'+arrBarang[i][2]+'">';
